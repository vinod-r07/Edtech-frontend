...
<div className="w-full max-w-full px-3 mx-auto mt-0 md:flex-0 shrink-0">
  ...
  <label for="terms" className="mb-2 ml-1 font-normal cursor-pointer select-none text-sm text-slate-700"> I agree the <a class="font-bold text-slate-700">Terms and Conditions</a>
